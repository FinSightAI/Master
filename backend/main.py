...
# Enrichment data added 2026-05-12 — surfaces in country_recommendations for UI cards.
# Sources: WHO World Health Report, EHCI 2018, EF EPI 2024, public insurance market data.
ISRAEL_COUNTRY_EXTRA_DATA = {
    "CYPRUS":      {"healthcare_quality": 75, "healthcare_label_he": "טוב — GeSY",        "healthcare_label_en": "Good — GeSY national system",
                    "english_proficiency": "Very High",  "english_score": 615,
                    "private_healthcare_usd_monthly": 80,
                    "inheritance_tax_to_il_family_note_he": "אין מס ירושה (בוטל 2000).",
                    "inheritance_tax_to_il_family_note_en": "No inheritance tax (abolished 2000)."},
    "UAE":         {"healthcare_quality": 78, "healthcare_label_he": "טוב מאוד — פרטי",   "healthcare_label_en": "Very Good — private system",
                    "english_proficiency": "Moderate",   "english_score": 540,
                    "private_healthcare_usd_monthly": 200,
                    "inheritance_tax_to_il_family_note_he": "אין מס ירושה. חוקי שריעה לבני משפחה — מומלץ צוואה!",
                    "inheritance_tax_to_il_family_note_en": "No inheritance tax. But Sharia may apply to estate — write a will!"},
    "PORTUGAL":    {"healthcare_quality": 75, "healthcare_label_he": "טוב — SNS",          "healthcare_label_en": "Good — SNS national system",
                    "english_proficiency": "High",       "english_score": 580,
                    "private_healthcare_usd_monthly": 60,
                    "inheritance_tax_to_il_family_note_he": "אין מס ירושה לקרובי משפחה (Imposto do Selo 10% רק לחיצוניים).",
                    "inheritance_tax_to_il_family_note_en": "No inheritance tax for close family (10% stamp duty for non-relatives only)."},
    "GEORGIA":     {"healthcare_quality": 55, "healthcare_label_he": "בינוני — דורש פרטי", "healthcare_label_en": "Average — private recommended",
                    "english_proficiency": "Low",        "english_score": 460,
                    "private_healthcare_usd_monthly": 40,
                    "inheritance_tax_to_il_family_note_he": "אין מס ירושה.",
                    "inheritance_tax_to_il_family_note_en": "No inheritance tax."},
    "ESTONIA":     {"healthcare_quality": 78, "healthcare_label_he": "טוב — דיגיטלי",      "healthcare_label_en": "Good — fully digital",
                    "english_proficiency": "High",       "english_score": 580,
                    "private_healthcare_usd_monthly": 90,
                    "inheritance_tax_to_il_family_note_he": "אין מס ירושה.",
                    "inheritance_tax_to_il_family_note_en": "No inheritance tax."},
    "BULGARIA":    {"healthcare_quality": 60, "healthcare_label_he": "בינוני — דורש פרטי", "healthcare_label_en": "Average — private recommended",
                    "english_proficiency": "Moderate",   "english_score": 520,
                    "private_healthcare_usd_monthly": 50,
                    "inheritance_tax_to_il_family_note_he": "מס ירושה 0.4-6.6% לפי קרבה.",
                    "inheritance_tax_to_il_family_note_en": "Inheritance tax 0.4-6.6% based on relationship."},
    "ROMANIA":     {"healthcare_quality": 55, "healthcare_label_he": "בינוני — דורש פרטי", "healthcare_label_en": "Average — private recommended",
                    "english_proficiency": "Moderate",   "english_score": 520,
                    "private_healthcare_usd_monthly": 45,
                    "inheritance_tax_to_il_family_note_he": "אין מס ירושה (לאחר 2 שנים מהפטירה).",
                    "inheritance_tax_to_il_family_note_en": "No inheritance tax (after 2 years from death)."},
    "HUNGARY":     {"healthcare_quality": 65, "healthcare_label_he": "טוב — TB ציבורי",    "healthcare_label_en": "Good — TB public + private",
                    "english_proficiency": "Moderate",   "english_score": 540,
                    "private_healthcare_usd_monthly": 60,
                    "inheritance_tax_to_il_family_note_he": "מס ירושה 18% לקרובים, 9% רק לדירה ראשית.",
                    "inheritance_tax_to_il_family_note_en": "Inheritance tax 18% for relatives, 9% on primary residence."},
    "URUGUAY":     {"healthcare_quality": 70, "healthcare_label_he": "טוב — מערכת ציבורית",   "healthcare_label_en": "Good — public + mutualistas",
                    "english_proficiency": "Moderate",   "english_score": 540,
                    "private_healthcare_usd_monthly": 80,
                    "inheritance_tax_to_il_family_note_he": "אין מס ירושה.",
                    "inheritance_tax_to_il_family_note_en": "No inheritance tax."},
    "PARAGUAY":    {"healthcare_quality": 55, "healthcare_label_he": "בינוני — דורש פרטי", "healthcare_label_en": "Average — private recommended",
                    "english_proficiency": "Low",        "english_score": 460,
                    "private_healthcare_usd_monthly": 50,
                    "inheritance_tax_to_il_family_note_he": "אין מס ירושה.",
                    "inheritance_tax_to_il_family_note_en": "No inheritance tax."},
    "MONACO":      {"healthcare_quality": 88, "healthcare_label_he": "מצוין — מערכת צרפתית", "healthcare_label_en": "Excellent — French-aligned",
                    "english_proficiency": "Moderate",   "english_score": 540,
                    "private_healthcare_usd_monthly": 300,
                    "inheritance_tax_to_il_family_note_he": "אין מס ירושה לקרובי משפחה ישירים. 8-16% לאחרים.",
                    "inheritance_tax_to_il_family_note_en": "No inheritance tax for direct relatives. 8-16% for others."},
    "PANAMA":      {"healthcare_quality": 60, "healthcare_label_he": "בינוני — דורש פרטי", "healthcare_label_en": "Average — private recommended",
                    "english_proficiency": "Moderate",   "english_score": 510,
                    "private_healthcare_usd_monthly": 100,
                    "inheritance_tax_to_il_family_note_he": "אין מס ירושה.",
                    "inheritance_tax_to_il_family_note_en": "No inheritance tax."},
    "MALTA":       {"healthcare_quality": 80, "healthcare_label_he": "טוב מאוד — דירוג WHO 5",   "healthcare_label_en": "Very Good — WHO ranks 5th",
                    "english_proficiency": "Very High",  "english_score": 625,
                    "private_healthcare_usd_monthly": 80,
                    "inheritance_tax_to_il_family_note_he": "אין מס ירושה (5% stamp duty על העברת נדל\"ן).",
                    "inheritance_tax_to_il_family_note_en": "No inheritance tax (5% stamp duty on property transfer)."},
    "SINGAPORE":   {"healthcare_quality": 88, "healthcare_label_he": "מצוין — Top 5 גלובלי",   "healthcare_label_en": "Excellent — Top 5 globally",
                    "english_proficiency": "High",       "english_score": 605,
                    "private_healthcare_usd_monthly": 250,
                    "inheritance_tax_to_il_family_note_he": "אין מס ירושה (בוטל 2008).",
                    "inheritance_tax_to_il_family_note_en": "No inheritance tax (abolished 2008)."},
    "SPAIN":       {"healthcare_quality": 80, "healthcare_label_he": "טוב מאוד — דירוג WHO 7",   "healthcare_label_en": "Very Good — WHO ranks 7th",
                    "english_proficiency": "Moderate",   "english_score": 540,
                    "private_healthcare_usd_monthly": 70,
                    "inheritance_tax_to_il_family_note_he": "Impuesto sobre Sucesiones: עד 34% (תלוי קהילה אוטונומית). מדריד וכמה אזורים כמעט פטורים לקרובים.",
                    "inheritance_tax_to_il_family_note_en": "Inheritance tax up to 34% (region-dependent). Madrid and few regions near-exempt for close relatives."},
    "ITALY":       {"healthcare_quality": 82, "healthcare_label_he": "מצוין — WHO 2",      "healthcare_label_en": "Excellent — WHO ranks 2nd",
                    "english_proficiency": "Low",        "english_score": 470,
                    "private_healthcare_usd_monthly": 70,
                    "inheritance_tax_to_il_family_note_he": "Imposta di successione 4-8% עם פטור גדול לבני משפחה ישירים (~€1M פטור).",
                    "inheritance_tax_to_il_family_note_en": "Inheritance tax 4-8% with large exemption for direct family (~€1M exempt)."},
    "NEW_ZEALAND": {"healthcare_quality": 78, "healthcare_label_he": "טוב — מערכת ציבורית",   "healthcare_label_en": "Good — public + private mix",
                    "english_proficiency": "Native",     "english_score": 700,
                    "private_healthcare_usd_monthly": 100,
                    "inheritance_tax_to_il_family_note_he": "אין מס ירושה (בוטל 1992).",
                    "inheritance_tax_to_il_family_note_en": "No inheritance tax (abolished 1992)."},
    "ANDORRA":     {"healthcare_quality": 80, "healthcare_label_he": "טוב מאוד — CASS",    "healthcare_label_en": "Very Good — CASS national",
                    "english_proficiency": "Moderate",   "english_score": 530,
                    "private_healthcare_usd_monthly": 90,
                    "inheritance_tax_to_il_family_note_he": "אין מס ירושה.",
                    "inheritance_tax_to_il_family_note_en": "No inheritance tax."},
}
